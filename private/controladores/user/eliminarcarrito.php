...
if ($resultcabecera1->num_rows > 0) {
    ...
    $sqlupdatet = "DELETE FROM carrito_detalle WHERE fk_carrito_producto=$producto_id and fk_carrito_cabecera=$cabecera and carrito_det_id=$codigo";
...
$sql = "select * from carrito_cabecera ,carrito_detalle ,producto where fk_carrito_cabecera=$cabecera and fk_persona_carrito=$codigo_user and fk_carrito_producto=producto_id and carrito_det_eliminado='N'AND carrito_eliminado='N'";
