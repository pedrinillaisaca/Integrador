...
<head>
    ...
    <script>
        ...
        function cargarNombre() {
            ...
            if(param.get('nombre')==null || param.get('nombre')===""){

            }else {
                document.getElementById('a_nombre').textContent = param.get('nombre');
                leu = '../../../private/vista/admin/cambiar_contrasena.php?codigo='+param.get('codigo');
                document.getElementById('pass').setAttribute('href', leu);
                isra='../../../private/vista/admin/modificar.php?codigo='+param.get('codigo');
                document.getElementById('mod').setAttribute('href',isra);
            }
        }
    </script>
</head>
    ...
    <nav class="navbar navbar-inverse" style="height: 80px">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active"><a id="a_nombre" href="#">Mi Cuenta</a></li>
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span
                                class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Actualizar datos</a></li>
                        <li><a id = 'pass' href="login.html">Cambiar contrasena</a></li>
